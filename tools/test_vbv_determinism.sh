...
#
# Default mode: byte-repeat checks and pre/post byte-identity checks.
# --quality: the quality/compliance matrix
...
# Baseline: the commit before this determinism change.
PRE_CHANGE_REF=HEAD~1
