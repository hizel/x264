...
#
# Matrix pinned from the PAFF B-field regression work
# (the "14/14 PAFF configs byte-exact" set).  A scripted matrix exists because
# an earlier "24/24 byte-exact" claim later did NOT reproduce on
...
#   mx05  -- the early-PAFF --ref 1 crash + CAVLC + no-deblock
#   mx03  -- --b-pyramid strict --ref 2 BREF-eviction crash
#   mx06  -- --ref 4 + --keyint 8 frame_num wrap
#   mx08  -- --no-deblock isolation of the bS deblock work
#
