# field-aware-sei Specification

## Purpose

Per-field SEI generation for field-picture (PAFF) streams: pic_timing with
field pic_struct, buffering_period/pic_timing delays in field units, and
honest dec_ref_pic_marking repetition.
