...
#define H2 if( longhelp == 2 ) printf
    ...
    H2( "      --paff                  Enable PAFF interlaced mode (field pictures).\n"
        ...
        "                              with MBAFF and AVC-Intra; incompatible with sliced\n"
        "                              threads, pulldown, intra refresh and frame packing.\n"
        "                              Frame threading is supported (a pair occupies two\n"
        "                              thread slots). See doc/paff.txt.\n" );
...
#   define  MAX_PTS_WARNING 3 /* arbitrary */
     ...
     * B field pictures and P weighted prediction (weightp) are supported;
