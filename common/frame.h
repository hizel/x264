...
typedef struct x264_frame
{
    ...
    /* PAFF: per-coded-field stat bits of this complementary pair
    ...
    int     b_kept_as_ref;
    /* PAFF: per-field "used for reference" marking.  [0]=top, [1]=bottom.
    ...
    /* PAFF: poc of first refframe in L0 per field parity, used to check
    ...
    int8_t  *ref[2];
    /* PAFF: per-field ref storage with a parity dimension
    ...
    /* PAFF: bitmask of which fields of this stored frame are currently
